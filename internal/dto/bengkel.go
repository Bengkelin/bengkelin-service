...
// BengkelServiceResponse for bengkel service data
type BengkelServiceResponse struct {
	ID          uint    `json:"id"`
...
// BengkelPhotoResponse for bengkel photo data
type BengkelPhotoResponse struct {
	ID       uint   `json:"id"`
...
type BengkelResponse struct {
	...
	Services     []BengkelServiceResponse   `json:"services,omitempty"`
	Photos       []BengkelPhotoResponse     `json:"photos,omitempty"`
