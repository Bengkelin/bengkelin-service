...
type ChatRoom struct {
	...
	BengkelID   string    `json:"bengkel_id" gorm:"type:varchar(36);not null;index"`
...
type ChatMessage struct {
	...
	SenderType string   `json:"sender_type" gorm:"type:enum('user','mitra');not null"` // 'user' or 'mitra'
	MessageType string  `json:"message_type" gorm:"type:enum('text','image','file','system');default:'text'"` // 'text', 'image', 'file', 'system'
...
type ChatParticipant struct {
	...
	ParticipantType string `json:"participant_type" gorm:"type:enum('user','mitra');not null"`
