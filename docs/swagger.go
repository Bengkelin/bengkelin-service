...
// @tag.name Auth
// @tag.description Authentication endpoints for users and mitras (bengkel owners)

// @tag.name Users
// @tag.description User management endpoints

// @tag.name Bengkels
// @tag.description Bengkel (automotive repair shop) management endpoints

// @tag.name Orders
// @tag.description Order and service management endpoints

// @tag.name Chat
// @tag.description Chat functionality endpoints

// @tag.name Health
// @tag.description Health check endpoints for monitoring

// @tag.name Metrics
// @tag.description Metrics endpoints for monitoring and observability
